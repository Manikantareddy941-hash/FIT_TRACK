                                ...
                                >
                                    {[...Array(5)].map((_, i) => (
                                        <motion.div
                                            ...
                                            animate={{ y: "-10%", scale: Math.random() * 0.5 + 0.5, opacity: [0, 1, 0] }}
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center z-10">
                        ...
                        >
                            <div className="text-7xl font-black italic tracking-tighter text-foreground drop-shadow-sm">
                                {waterGlasses}
                                <span className="text-2xl text-accent/50 not-italic ml-2 tracking-widest uppercase">/{waterGoal}</span>
                            </div>
                            <div className="text-[10px] font-black uppercase tracking-[0.4em] text-accent/70 mt-2">Units Consumed</div>
                        </motion.div>
                    </div>

                    {/* Percentage Indicator */}
                    <div className="absolute top-6 right-8 z-10">
                        <div className="text-[10px] font-black italic text-foreground/40 tracking-widest uppercase">{Math.round(percentage)}% Full</div>
                    </div>
                </div>
